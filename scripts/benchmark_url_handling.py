...
# Use the adapter for the new implementation
from src.utils.helpers import URLInfo as NewURLInfo
...
def main():
    ...
    # New implementation
    results['new'] = benchmark_implementation(NewURLInfo, urls, "New Implementation (tldextract)")
    
    # Original implementation (if available)
    if OldURLInfo:
        results['old'] = benchmark_implementation(OldURLInfo, urls, "Original Implementation")
