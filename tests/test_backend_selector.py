...
class TestBackendSelector:
    ...
    def test_select_backend_with_url_pattern_match(self):
        ...
        selector.register_backend(
            backend1, BackendCriteria(priority=10, url_patterns=["docs"])
        )
        selector.register_backend(
            backend2, BackendCriteria(priority=5, url_patterns=["api"])
        )
    ...
    def test_select_backend_priority(self):
        ...
        selector.register_backend(
            backend2, BackendCriteria(priority=20, url_patterns=["docs"])
        )
    ...
    def test_select_backend_no_match(self):
        ...
        selector.register_backend(
            backend, BackendCriteria(priority=10, url_patterns=["docs"])
        )
    ...
    def test_select_backend_with_multiple_patterns(self):
        ...
        selector.register_backend(
            backend, BackendCriteria(priority=10, url_patterns=["docs", "api", "blog"])
        )
