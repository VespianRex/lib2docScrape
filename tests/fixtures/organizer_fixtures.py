...
def create_test_content():
    ...
    def _factory(url: str = "https://example.com/doc",
        ...
        code_blocks = code_blocks or [
            ...
            {"language": "javascript", "code": "function test() {\n    return true;\n}"}
        ]
        ...
        if content is None:
            content = {
                ...
                "links": [
                    {"url": "https://example.com/related", "text": "Related Doc", "type": "internal"},
                    {"url": "https://external.com/reference", "text": "External Reference", "type": "external"}
                ]
            }
...
def document_version_factory(create_test_content):
    ...
    def _factory(url: str = "https://example.com/doc", 
                ...
                days_ago: int = 0) -> DocumentVersion:
        """
...
def document_collection_factory(document_version_factory):
    ...
    def _factory(url: str = "https://example.com/doc",
                num_versions: int = 3,
                category: str = "api") -> DocumentCollection:
        """
        ...
        for i in range(num_versions):
            ...
            versions.append(document_version_factory(url=url, version_number=version_num, days_ago=days_ago))
