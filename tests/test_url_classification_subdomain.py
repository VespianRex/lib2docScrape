...
class TestURLClassificationSubdomain:
    ...
    @pytest.mark.parametrize("url, base_url, expected_type, description", [
        ...
        ("https://blog.example.com", "https://docs.example.com/", URLType.EXTERNAL, "Different subdomain, same parent domain - treated as external"),
        ("//blog.example.com/latest", "https://docs.example.com/", URLType.EXTERNAL, "Protocol-relative link to different subdomain"),

        # Link from a subdomain to the parent domain
        ("https://example.com/about", "https://docs.example.com/", URLType.EXTERNAL, "Link from subdomain to parent domain"),
        ...
        ("https://api.internal.dev.example.com", "https://docs.example.com/", URLType.EXTERNAL, "Deeply nested different subdomain"),
    ...
    #     info_external = URLInfo("https://blog.example.com", base_url="https://docs.example.com/")
    ...
    #     info_internal = URLInfo("https://blog.example.com", base_url="https://docs.example.com/") # Pass config or modify global state
