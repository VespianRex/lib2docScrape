...
def test_crawl_target_default_instantiation():
    ...
    assert target.include_patterns == []  # Default value has been changed to an empty list
...
def test_crawl_target_custom_values():
    ...
    custom_values = {
        ...
        "include_patterns": ["/docs/"],  # Field name has been changed from required_patterns to include_patterns
        "max_pages": 100,
    ...
    assert target.include_patterns == ["/docs/"]  # Field name has been changed from required_patterns to include_patterns
