...
class DocumentCategorizer:
    ...
    def _load_stopwords(self) -> Set[str]:
        ...
        try:
            ...
            return {
                ...
                'nor', 'be', 'am', 'are', 'is', 'was', 'were', 'been', 'being', 'have',
                'has', 'had', 'having', 'do', 'does', 'did', 'doing', 'would', 'should',
                'could', 'ought', 'i', 'you', 'he', 'she', 'it', 'we', 'they', 'me',
    ...
    def train_model(self, documents: List[ProcessedContent], num_categories: int = 10) -> None:
        """
        ...
        for doc in documents:
            title = doc.title or ""
            content = doc.content.get("text", "") if isinstance(doc.content, dict) else ""
    ...
    def categorize_document(self, document: ProcessedContent) -> List[Tuple[str, float]]:
        """
        ...
        content = document.content.get("text", "") if isinstance(document.content, dict) else ""
        text = f"{title} {content}"
    ...
    def save_model(self, model_path: str) -> None:
        ...
        categories_data = {
            ...
            for cat_id, cat in self.model.categories.items()
        }
    ...
    def load_model(self, model_path: str) -> None:
        ...
        logger.info(f"Loaded categorization model from {model_path} with {len(categories)} categories")
