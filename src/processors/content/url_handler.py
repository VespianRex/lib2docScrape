...
from urllib.parse import urlparse, urljoin # Moved import to top level
...
def is_safe_url(url: str) -> bool:
    ...
    try:
        ...
        # Allow mailto scheme
        is_mailto = parsed.scheme == 'mailto'
        ...
        if not parsed.scheme and bool(parsed.netloc): # Scheme missing but domain present? Invalid.
             return False
