...
class RetryWithStrategy:
    ...
    def __init__(self, strategy: RetryStrategy, max_retries: int = 3, logger: Optional[logging.Logger] = None):
        """
    ...
    async def retry_async(self, operation, *args, **kwargs):
        ...
        for attempt in range(self.max_retries + 1):
            try:
                ...
                last_exception = e
                self.logger.warning(f"Attempt {attempt + 1}/{self.max_retries + 1} failed: {str(e)}")
